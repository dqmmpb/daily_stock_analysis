...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "API_PORT": {
        ...
        "description": "Port for API service. (Legacy WEBUI_PORT still supported as fallback)",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "API_HOST": {
        "title": "API Service Host",
        "description": "Host address for API service. (Legacy WEBUI_HOST still supported as fallback)",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "API_ENABLED": {
        ...
        "description": "Whether to start API service on launch. (Legacy WEBUI_ENABLED still supported as fallback)",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
